...
public abstract class CommonCrudCoreService<
    ...
    public DTO findById(FindByIdCommand input) {
        log.info("Iniciou findById para o ID: {}", input.getId());
        DTO dto = findByIdPortOutbound.process(input);
        log.info("Finalizou findById com sucesso para o ID: {}", input.getId());
        return dto;
    }
    ...
    public DTO update(UpdateCommand input) {
        log.info("Iniciou update para o ID: {}", input.getId());
        DTO dto = updatePortOutbound.process(input);
        log.info("Finalizou update com sucesso para o ID: {}", input.getId());
        return dto;
    }
    ...
    public void delete(DeleteCommand input) {
        log.info("Iniciou delete para o ID: {}", input.getId());
        deletePortOutbound.process(input);
        log.info("Finalizou delete com sucesso para o ID: {}", input.getId());
    }
}