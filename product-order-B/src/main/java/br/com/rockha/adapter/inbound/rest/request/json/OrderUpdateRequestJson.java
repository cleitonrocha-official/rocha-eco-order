...
@Schema(name = "PedidoUpdateRequest", description = "Objeto de requisição para atualizar um Pedido existente")
public record OrderUpdateRequestJson(
	    ...
	    @JsonProperty("produtos") List<OrderItemRequestJson> products
